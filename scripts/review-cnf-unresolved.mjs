...
const HINTS = {
  ...
  "laitue": ["lettuce raw", "iceberg lettuce raw", "green leaf lettuce raw", "laitue crue", "laitue iceberg crue"],
  "asperges": ["asparagus cooked", "asperge bouillie", "asperge cuite"],
  "betterave": ["beet raw", "beets raw", "beet boiled", "beets boiled", "beet root", "betterave crue", "betterave bouillie"],
  ...
  "thon": ["tuna cooked", "tuna fresh cooked", "tuna yellowfin cooked", "tuna bluefin cooked", "tuna canned water", "thon cuit", "thon frais cuit", "thon conserve eau"],
  "fromage à la crème": ["cream cheese regular", "fromage a la creme ordinaire"],
  "crème glacée": ["ice cream vanilla 11 milk fat", "ice cream vanilla", "creme glacee vanille 11", "creme glacee vanille"],
  ...
  "riz": ["white rice long grain cooked", "white rice medium grain cooked", "white rice cooked", "riz blanc grain long cuit", "riz blanc cuit", "rice cooked"],
  "fromage": ["cheddar mild", "cheddar cheese", "fromage cheddar doux", "fromage cheddar"],
  "porc effiloché": ["pulled pork", "porc effiloche"],
  "fajitas": ["fajita", "fajitas"],
  "manioc": ["cassava cooked", "cassava boiled", "cassava", "manioc cuit", "manioc bouilli", "manioc"],
  "fruits": []
};
