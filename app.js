...
function formatSleepDuration(hours) {
  ...
  function journalSummaryHtml(day, meals) {
    ...
    return `<section class="journal-summary" aria-labelledby="journalSummaryTitle"><div class="journal-summary-intro"><div><p class="eyebrow">Ajout rapide</p><h2 id="journalSummaryTitle">Que veux-tu noter?</h2></div></div><div class="journal-summary-grid">${sleepPrompt}<button type="button" class="journal-summary-action journal-summary-action--meal" id="journalSummaryMeal"><span>Ajouter un</span><strong>Repas</strong><span class="summary-action-watermark" aria-hidden="true">🍲</span><span class="summary-action-plus" aria-hidden="true">+</span><small>${meals.length} repas ou collation${meals.length !== 1 ? "s" : ""} cette journée</small></button><button type="button" class="journal-summary-action journal-summary-action--feeling ${dueFeeling ? "needs-brain-action feeling-needs-brain-action" : ""}" id="journalSummaryFeeling">${feelingBrain}<span class="feeling-summary-copy"><span>${dueFeeling ? "À compléter" : "Ajouter un"}</span><strong>Ressenti</strong><small>${dueFeeling ? "Un ressenti après est maintenant attendu" : feelingCount ? `${feelingCount} repas documenté${feelingCount > 1 ? "s" : ""}` : "Avant, après ou hors repas"}</small></span><span class="summary-feeling-visual" aria-hidden="true"><svg viewBox="0 0 112 76" role="presentation"><defs><linearGradient id="feelingSadGradient" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#8f88a8"/><stop offset="1" stop-color="#b3aec2"/></linearGradient><linearGradient id="feelingGoodGradient" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f0d7bd"/><stop offset="1" stop-color="#f2a86e"/></linearGradient></defs><circle class="feeling-face feeling-face-sad" cx="42" cy="39" r="27" fill="url(#feelingSadGradient)"/><circle class="feeling-face feeling-face-good" cx="72" cy="37" r="29" fill="url(#feelingGoodGradient)"/><path class="feeling-line sad-brow" d="M26 29q8-6 15 0"/><path class="feeling-line sad-brow" d="M43 29q7-5 13 1"/><path class="feeling-line" d="M27 37q6 4 12 0"/><path class="feeling-line" d="M44 38q6 4 11 0"/><path class="feeling-line" d="M34 53q8-7 16 0"/><path class="feeling-line good-brow" d="M58 28q7-5 13 0"/><path class="feeling-line good-brow" d="M76 28q7-5 13 0"/><path class="feeling-line" d="M58 36q6 4 12 0"/><path class="feeling-line" d="M77 36q6 4 12 0"/><path class="feeling-line good-smile" d="M62 50q10 10 20 0"/><ellipse class="feeling-blush" cx="57" cy="44" rx="5" ry="2.7"/><ellipse class="feeling-blush" cx="87" cy="44" rx="5" ry="2.7"/></svg></span><span class="summary-action-plus" aria-hidden="true">+</span></button>${summaryActivityHtml(day)}${summaryHydrationHtml(day)}${stepsProgressHtml(day, true)}</div></section>`;
  }
