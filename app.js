...
function dailyMacroSummaryHtml(meals){
  ...
  return `<details class="daily-macros-card" aria-label="Estimation nutritionnelle de la journée"><summary class="daily-macros-head"><span>Estimation nutritionnelle</span><span class="daily-macros-head-right"><strong>≈ ${calories.toLocaleString('fr-CA')} kcal</strong><b class="weekly-trends-chevron" aria-hidden="true">›</b></span></summary><div class="daily-macros-details"><div class="daily-macros-grid"><span><b>🥩 ${protein.toLocaleString('fr-CA')} g</b><small>Protéines</small></span><span><b>🍞 ${carbs.toLocaleString('fr-CA')} g</b><small>Glucides</small></span><span><b>🥑 ${fat.toLocaleString('fr-CA')} g</b><small>Lipides</small></span>${extra}</div><p>Valeurs approximatives, calculées à partir des aliments reconnus. ${coverage}</p></div></details>`;
}
