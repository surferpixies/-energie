...
function installDemoReadOnlyGuard(){
  ...
  document.addEventListener("click",event=>{
    ...
    if(control.closest("[data-open-demo-profile],#leaveDemoProfile,#leaveDemoQuick,#replayDemoTour,.nav-item,.brain-proof,.why-demo-insight"))return;
