...
function snackIconForText(text){const value=String(text||"").toLocaleLowerCase("fr-CA").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[’']/g," ");const icons=[];if(/\b(pomme|pommes|apple|apples)\b/.test(value))icons.push("🍎");if(/\b(kiwi|kiwis)\b/.test(value))icons.push("🥝");if(/\b(fromage|cheese|feta|mozzarella|cheddar|gruyere|gouda)\b/.test(value))icons.push("🧀");return icons.length?icons.join(""):"🧺";}function mealIcon(t,description=""){if(t==="Collation")return snackIconForText(description);return({"Déjeuner":"🍳","Dîner":"🥗","Souper":"🍲","Boisson":"🥤"})[t]||"🍽️"}
