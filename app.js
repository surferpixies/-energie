...
function resetBarcodeResult(){barcodeLastCode="";barcodeLastProduct=null;$("#barcodeResult").hidden=true;$("#barcodeProductName").value="";$("#barcodeBrand").textContent="";$("#barcodeProductImage").hidden=true;$("#barcodeProductImage").removeAttribute("src");$("#barcodeCustomPortion").hidden=true;$$('[data-portion-multiplier]').forEach(b=>b.classList.toggle("active",b.dataset.portionMultiplier==="1"))}
...
$("#barcodePortionGrams").addEventListener("input",updateBarcodePortion);$$('[data-portion-multiplier]').forEach(button=>button.onclick=()=>selectBarcodePortion(button.dataset.portionMultiplier));
