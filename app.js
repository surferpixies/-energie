...
function activeReferenceBrain(){
  ...
  return activeDemoProfile()?.brain||window.EnergieDemoProfiles?.referenceBrains?.[db.settings.demoProfileId]||null
}
