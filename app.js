...
function snackIconForText(text){const clean=String(text||"").toLocaleLowerCase("fr-CA").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[’']/g," ").replace(/[^a-z0-9]+/g," ").trim();const rules=[{terms:["yogourt","yaourt","yogourt grec"],icon:"🥣",priority:100},{terms:["pomme","pomme rouge","pomme verte"],icon:"🍎",priority:95},{terms:["kiwi","kiwis"],icon:"🥝",priority:95},{terms:["banane"],icon:"🍌",priority:95},{terms:["orange","mandarine","clementine"],icon:"🍊",priority:95},{terms:["poire"],icon:"🍐",priority:95},{terms:["fraise","fraises"],icon:"🍓",priority:95},{terms:["bleuet","bleuets","framboise","framboises","mure","mures","cassis","myrtille","myrtilles","canneberge","canneberges"],icon:"🫐",priority:95},{terms:["ananas","ananas frais"],icon:"🍍",priority:95},{terms:["mangue","mangues"],icon:"🥭",priority:95},{terms:["melon d eau","melon","melons","pasteque","watermelon"],icon:"🍉",priority:95},{terms:["raisin","raisins","papaye","papayes","prune","prunes","nectarine","nectarines","peche","peches"],icon:"🍑",priority:95},{terms:["fromage de chevre","chevre","brie","camembert","feta","mozzarella","fromage"],icon:"🧀",priority:110},{terms:["noix","noix de cajou","pistache","amande","amandes","cacahu","cajou","noix de coco"],icon:"🥜",priority:90},{terms:["barre","barre tendre","protein bar","snack bar","chocolate bar","barre de chocolat"],icon:"🍫",priority:85},{terms:["cookie","cookies","biscuit","biscuits","cracker","crackers","galette","galettes","craquelin","craquelins"],icon:"🍪",priority:80},{terms:["pain","toast","bagel","croissant","pain grille"],icon:"🍞",priority:75},{terms:["chips","croustille","croustilles","nachos","popcorn","pop corn"],icon:"🥨",priority:80},{terms:["chocolat","chocolat noir","chocolat blanc","chocolat au lait","choco"],icon:"🍫",priority:85},{terms:["legume","carotte","carottes","brocoli","brocolis","concombre","concombres","tomate","tomates","salade","salades","poivron","poivrons","celeri","haricot vert","haricots verts","courgette","courgettes","champignon","champignons","avocat","avocats","aubergine","aubergines","epinard","betterave","betteraves","asperge","asperges","chou","choux"],icon:"🥗",priority:90}];const escapeTerm=term=>term.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");const hasTerm=(value,term)=>{const pattern=term.includes(" ")?new RegExp(`(?:^|\\s)${escapeTerm(term)}(?:$|\\s)`) : new RegExp(`\\b${escapeTerm(term)}\\b`);return pattern.test(value)};const matches=[];for(const rule of rules){const matchedTerms=rule.terms.filter(term=>hasTerm(clean,term));if(!matchedTerms.length)continue;const specificity=matchedTerms.reduce((sum,term)=>sum+(term.includes(" ")?3:1),0);matches.push({icon:rule.icon,score:rule.priority+specificity})}if(!matches.length)return "�";matches.sort((a,b)=>b.score-a.score);return matches[0].icon}
function mealIcon(t,description=""){if(t==="Collation")return snackIconForText(description);return({"Déjeuner":"🍳","Dîner":"🥗","Souper":"🍲","Boisson":"🥤"})[t]||"🍽️"}
