...
function snackIconForText(text){const clean=String(text||"").toLocaleLowerCase("fr-CA");const patterns=[{regex:/\b(yogourt|yaourt)\b/,icon:"🥣"},{regex:/\b(pomme|pomme rouge|pomme verte)\b/,icon:"🍎"},{regex:/\b(kiwi|kiwis)\b/,icon:"🥝"},{regex:/\b(banane)\b/,icon:"🍌"},{regex:/\b(orange|mandarine|clémentine|clementine)\b/,icon:"🍊"},{regex:/\b(poire)\b/,icon:"🍐"},{regex:/\b(fraise|fraises)\b/,icon:"🍓"},{regex:/\b(bleuet|bleuets|framboise|framboises|mûre|mures|cassis|cassis|myrtille|myrtilles|canneberge|canneberges)\b/,icon:"🫐"},{regex:/\b(ananas|ananas frais)\b/,icon:"🍍"},{regex:/\b(mangue|mangues)\b/,icon:"🥭"},{regex:/\b(pêche|peche|pêches|peches|melon|melons|raisin|raisins|papaye|papayes|prune|prunes|nectarine|nectarines)\b/,icon:"🍑"},{regex:/\b(fromage|cheese|feta|mozzarella|brie|camembert)\b/,icon:"🧀"},{regex:/\b(noix|noix de cajou|pistache|amande|amandes|cacahu|cajou|noix de coco)\b/,icon:"🥜"},{regex:/\b(barre|barre tendre|protein bar|snack bar|chocolate bar|barre de chocolat)\b/,icon:"🍫"},{regex:/\b(cookie|cookies|biscuit|biscuits|cracker|crackers|galette|galettes)\b/,icon:"🍪"},{regex:/\b(pain|toast|bagel|croissant|pain grillé|pain grille)\b/,icon:"🍞"},{regex:/\b(chips|croustille|croustilles|nachos|popcorn|pop-corn)\b/,icon:"🥨"},{regex:/\b(chocolat|chocolat noir|chocolat blanc|chocolat au lait|choco)\b/,icon:"🍫"},{regex:/\b(légume|legume|carotte|carottes|brocoli|brocolis|concombre|concombres|tomate|tomates|salade|salades|poivron|poivrons|céleri|celeri|haricot vert|haricots verts|courgette|courgettes|champignon|champignons|avocat|avocats|aubergine|aubergines|épinard|epinard|betterave|betteraves|asperge|asperges|chou|choux)\b/,icon:"🥗"}];return patterns.find(p=>p.regex.test(clean))?.icon||"🍎"}
