...
function snackIconForText(text){return mealIcon("Collation",text);}function mealIcon(t,description=""){if(t==="Collation")return `<span aria-hidden="true" style="display:inline-block;width:1.1em;height:1.1em;vertical-align:-0.12em"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect x="12" y="18" width="32" height="28" rx="8" ry="8" fill="none" stroke="currentColor" stroke-width="4"/><path d="M24 18V12a8 8 0 0 1 16 0v6" fill="none" stroke="currentColor" stroke-width="4"/><path d="M32 30l10 10" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M44 28c3 0 6 2 6 6 0 4-3 8-8 8-2 0-4-1-5-2" fill="none" stroke="#c97a2b" stroke-width="4" stroke-linecap="round"/><circle cx="44" cy="24" r="8" fill="#4caf50"/><path d="M44 16c2 2 3 4 3 7" stroke="#2e7d32" stroke-width="3" stroke-linecap="round"/><path d="M44 16c-2 2-3 3-3 6" stroke="#2e7d32" stroke-width="3" stroke-linecap="round"/><path d="M30 32l8-8" stroke="#c97a2b" stroke-width="4" stroke-linecap="round"/><path d="M28 34l4 4" stroke="#c97a2b" stroke-width="4" stroke-linecap="round"/></svg></span>`;return({"Déjeuner":"🍳","Dîner":"🥗","Souper":"🍲","Boisson":"🥤"})[t]||"🍽️"}
