(() => {
  ...
  function renderProfile() {
    ...
    $("#settingCalorieTargetMode")?.addEventListener("change", (event) => {
      db.settings.calorieTargetMode = event.target.value === "fixed" ? "fixed" : "estimated";
