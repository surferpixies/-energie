(() => {
  ...
  const CATEGORY_DEFINITIONS = [
    ...
    { id:"starches", icon:"🥔", labels:{"fr-CA":"Féculents","fr-FR":"Féculents",en:"Starches"} },
  ...
  const FOOD_DEFINITIONS = [
    ...
    { id:"other_bread", synonyms:["pain","pain brun","brown bread","pain pita","pita bread","tortilla","wrap"], exclusions:["pain de ble entier","pain multigrain","pain complet"], categories:["gluten","refined_grains","starches","processed_foods"] },
    ...
    { id:"rice_generic", synonyms:["riz","riz basmati","basmati rice"], exclusions:["riz brun","brown rice","riz complet","riz sauvage","wild rice"], categories:["refined_grains","starches"] },
    ...
    { id:"bulgur", synonyms:["boulgour","bulgur"], categories:["gluten","whole_grains","starches","high_fiber"] },
    { id:"granola", synonyms:["granola"], categories:["whole_grains","starches","processed_foods","high_fiber"] },
    { id:"gnocchi", synonyms:["gnocchi","gnocchis"], categories:["gluten","refined_grains","starches"] },
    { id:"ramen_noodles", synonyms:["nouilles ramen","ramen noodles"], categories:["gluten","refined_grains","starches","processed_foods"] },
    { id:"rice_noodles", synonyms:["nouilles de riz","rice noodles"], categories:["refined_grains","starches"] },
    ...
    { id:"apple", synonyms:["pomme","pommes","apple","apples"], exclusions:["pomme de terre","pommes de terre","puree de pommes de terre","mashed potatoes"], categories:["fruits","high_fiber"] },
    ...
    { id:"pear", synonyms:["poire","poires","pear","pears"], categories:["fruits","high_fiber"] },
    { id:"cherries", synonyms:["cerise","cerises","cherry","cherries"], categories:["fruits"] },
    { id:"other_fruits", synonyms:["figue","figues","figue fraiche","fresh fig","grenade","pomegranate","litchi","lychee","goyave","guava"], categories:["fruits","high_fiber"] },
    ...
    { id:"celery", synonyms:["celeri","celeris","celery"], categories:["vegetables","high_fiber"] },
    { id:"eggplant", synonyms:["aubergine","aubergines","eggplant","eggplants"], categories:["vegetables","high_fiber"] },
    { id:"asparagus", synonyms:["asperge","asperges","asparagus"], categories:["vegetables","high_fiber"] },
    { id:"green_beans", synonyms:["haricot vert","haricots verts","green bean","green beans"], categories:["vegetables","high_fiber"] },
    { id:"snow_peas", synonyms:["pois mange tout","snow pea","snow peas"], categories:["vegetables","high_fiber"] },
    { id:"radish", synonyms:["radis","radish","radishes"], categories:["vegetables"] },
    { id:"rutabaga", synonyms:["rutabaga","rutabagas"], categories:["vegetables","high_fiber"] },
    ...
    { id:"peas", synonyms:["petit pois","petits pois","pois verts","green peas","split peas","pois casses"], categories:["legumes","plant_protein","high_fiber"] },
    ...
    { id:"soy_milk", synonyms:["lait de soya","lait de soja","soy milk"], categories:["soy","plant_protein","high_protein","processed_foods"] },
    { id:"seitan", synonyms:["seitan"], categories:["plant_protein","high_protein","gluten"] },
    { id:"falafel", synonyms:["falafel","falafels"], categories:["legumes","plant_protein","high_protein","high_fiber","processed_foods"] },
    { id:"veggie_burger", synonyms:["burger vegetarien","veggie burger","vegetarian burger","galette vegetale"], categories:["plant_protein","high_protein","processed_foods"] },
    ...
    { id:"scallops", synonyms:["petoncle","petoncles","scallop","scallops"], categories:["seafood","high_protein"] },
